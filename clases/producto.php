...
class Producto{
	...
	function insertar($nombre,$precio,$descripcion,$imagen){
		$consulta="INSERT INTO producto (pk_producto, nombre, precio, descripcion,imagen,fk_promocion) VALUES (null, '{$nombre}', '{$precio}','{$descripcion}','{$imagen}',1)";
